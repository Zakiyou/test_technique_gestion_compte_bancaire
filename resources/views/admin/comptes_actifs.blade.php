...
@section('titre', "Liste de toutes les comptes bancaires actifs")
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="title">
                            <h4>Liste de tous les comptes bancaires actifs</h4>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            ...
                                            <a class="dropdown-item" href="javascript:void(0);" onclick="desactiverCompte({{ $compte->id }})">
                            ...
                            <tr>
                                <td colspan="7" class="text-center">
                                    <strong>Aucun compte bancaire actif disponible actuellement.</strong>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
...
<script>
    ...
    Swal.fire({
        title: 'Êtes-vous sûr?',
        text: "Voulez-vous vraiment désactiver ce compte bancaire?",
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: '/dashboard/comptes/' + id + '/desactiver',
                type: 'POST',
                data: {
                ...
                success: function(response) {
                    if (response.success) {
                        Swal.fire(
                            ...
                            'Le compte bancaire a bien été désactivé.',
                            'success'
                        );
                        setTimeout(function() {
                            window.location.reload();
                        }, 1500); // Rafraîchissement après l'affichage de l'alerte
                    } else {
                        Swal.fire({
                            icon: 'error',
                            title: 'Erreur',
                ...
                error: function() {
                    Swal.fire({
                        icon: 'error',
                        title: 'Erreur',
                        text: 'Une erreur est survenue lors de la désactivation du compte.',
                    });
                }
            });
        }
